...
module TestRutema
  class TestReporters < Test::Unit::TestCase
    def test_junit
      ...
      assert_equal("<?xml version='1.0'?><testsuite errors='0' failures='0' tests='0' time='0.000157'><testcase name='_setup_' time='0.000157'/></testsuite>",
                   junit_reporter.process_data([], states, []))
    end
